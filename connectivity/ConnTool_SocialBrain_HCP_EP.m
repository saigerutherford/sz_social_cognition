...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Exp = '/nfs/local/fatty/saige/HCP_EP';
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
confoundFile = ''; %unsmoothed data after AROMA Denoise.sh
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
connectFile  = 'clean_rest_aroma'; %smoothed output image from AROMA
...
EPIBrainMaskTemplate = ...
    '[Exp]/rrs_spm12_mni_icbm152_nlin_sym_09b_1xero_s8_thrp35_mask.nii';
...
DespikeParametersTemplate = ...
    '';
DespikeReplacementOption  = '';
DespikeReplacementInterp  = '';
...
% ROICenters = [0 -48 26];
% ROIfile = '';
% ROIlist = dataset('File',ROIfile,'Delimiter',',');
% ROICenters = zeros(length(ROIlist),3);
% ROICenters(:,1)=round(ROIlist.X);
% ROICenters(:,2)=round(ROIlist.Y);
% ROICenters(:,3)=round(ROIlist.Z);
...
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ROITemplate = '/nfs/local/fatty/saige/social_brain_ROIs/AAL3/rs_seeds_fmriprep/';
ROIImages = {
    };
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
OutputTemplate  = '[Exp]/FirstLevel/[Subject]/';
OutputName      = 'AAL3_fmriprep';
...
global mcRoot
%DEVSTART
mcRoot = '/nii/bionic/MethodsCore12/';
%DEVSTOP
